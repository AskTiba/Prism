  ...
  return (
    <div className="rounded-xl bg-white px-5 py-6">
      <div className="mb-4 flex items-center justify-between">
        ...
        <a href="/budgets" className="text-sm text-grey-500 hover:text-grey-900">See Details</a>
      </div>
      <ul className="space-y-3">
        {items.map((budget) => (
          <li key={budget.id} className="flex items-center gap-3">
            <span className="h-3 w-3 rounded-full" style={{ backgroundColor: budget.theme }} />
